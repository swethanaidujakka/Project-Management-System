...
.pagination a {
  ...
  text-decoration: none;
	...
	<body>
	  ...
	  <a href="student.php"class="icon-a"><i class="fa fa-graduation-cap"></i>   Students</a>
	  ...
	  <a href="viewmarks.php"class="icon-a"><i class="fa fa-trophy" aria-hidden="true"></i>   Viewmarks</a>
	...
	<div class="horzontial">
        <span style="font-size:30px;cursor:pointer; color: black;" class="nav"  >☰ COORDINATOR</span>
	<span style="font-size:30px;cursor:pointer; color: black;" class="nav2"  >☰ COORDINATOR</span>
    </div>
